...
1. Explain the difference between `Relational Databases` and `SQL`.
    ...
    Relations databases are tabular data storage where as SQL is a language used to manage the data

2. Why do tables need a `primary key`?

    To refer to each item with a table uniquely
...
4. What do we need in order to have a _many to many_ relationship between two tables.
    ...
    A connect table with aforeign key referencing the primary key of each table.
